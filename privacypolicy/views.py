	...
	def get(self, request):
		if request.method == 'GET':
			...
			if pageSize < 10:
				...
				return redirect("/privacypolicy/input/v1")
			...
			if totalData < 6:
				...
				return redirect("/privacypolicy/input/v2")
			...
			return render(request, "output.html", {'pageContent' : gradedData, 'lines' : pageSize, 'finalScores' : finalScores, 'finalColor' : finalColor , 'error' : error})
...
class v1View(TemplateView):
	template_name = "scrapv1.html"

class v2View(TemplateView):
	template_name = "scrapv2.html"